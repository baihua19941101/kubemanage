...
func NewRouter(store *infra.Store, k8sAdapterMode string, secretKey string) *gin.Engine {
	...
	api := r.Group("/api/v1")
	{
		...
		api.GET("/nodes", resourceHandler.ListNodes)
		api.GET("/nodes/:name", resourceHandler.GetNode)
		api.GET("/nodes/:name/yaml", resourceHandler.GetNodeYAML)
		api.GET("/nodes/:name/yaml/download", resourceHandler.DownloadNodeYAML)
		api.GET("/limitranges", resourceHandler.ListLimitRanges)
		api.GET("/limitranges/:name", resourceHandler.GetLimitRange)
		api.GET("/limitranges/:name/yaml", resourceHandler.GetLimitRangeYAML)
		api.GET("/limitranges/:name/yaml/download", resourceHandler.DownloadLimitRangeYAML)
		api.GET("/resourcequotas", resourceHandler.ListResourceQuotas)
		api.GET("/resourcequotas/:name", resourceHandler.GetResourceQuota)
		api.GET("/resourcequotas/:name/yaml", resourceHandler.GetResourceQuotaYAML)
		api.GET("/resourcequotas/:name/yaml/download", resourceHandler.DownloadResourceQuotaYAML)
		api.GET("/networkpolicies", resourceHandler.ListNetworkPolicies)
		api.GET("/networkpolicies/:name", resourceHandler.GetNetworkPolicy)
		api.GET("/networkpolicies/:name/yaml", resourceHandler.GetNetworkPolicyYAML)
		api.GET("/networkpolicies/:name/yaml/download", resourceHandler.DownloadNetworkPolicyYAML)
