...
| P203 | 第二阶段任务3：服务发现扩展 | 待开始 | Ingress/HPA 与关联查询（下一任务） |
...
| T029 | P202-E：Workloads 导航分组直出改造 | 已完成 | 已去除“工作负载”父按钮，Workloads 分组直接展示 6 类资源并子路由访问 |
...
- 2026-04-01：按需求调整 Workloads 导航为分组直出 6 类资源（无“工作负载”父按钮）
