...
| P202 | 第二阶段任务2：工作负载扩展 | 进行中 | 已完成重启规划与拆分，按 P202-A~P202-D 执行 |
...
| T025 | P202-A：后端 service 扩展 | 待开始 | StatefulSet/DaemonSet/Job/CronJob 列表与 YAML 存取 |
| T026 | P202-B：后端 handler/router 扩展 | 待开始 | 新增资源读写接口，接入 RBAC 与写审计 |
| T027 | P202-C：前端工作负载页重建 | 待开始 | 新增 4 类资源展示、详情抽屉、YAML 编辑 |
| T028 | P202-D：联调与回归验证 | 待开始 | 后端测试、前端构建、P202 冒烟验证 |
